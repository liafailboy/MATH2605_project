...
def gs_iter(a_b_aug, u, e, m):
	...
	:param m: the maximum number of iterations to try before giving up
	"""
	x_n, iterations, error =  iterative_methods.gauss_seidel(a_b_aug, u, e, m)
...
def print_usage():
    print 'Sample Usage:'
    print 'python gs_driver.py <path_to_augmented_matrix> <path_to_x_0> <e> <m>'
    print 'python gs_driver.py test/iter_aug.dat test/iter_x_0.dat 0.0001 30'
